...
nmap <leader>b :Todo<cr>
nmap <leader>ba <Plug>bujo#AddTodoNormal
imap <leader>ba <Plug>bujo#AddTodoInsert

nmap <leader>bc <Plug>bujo#CheckTodoNormal
imap <leader>bc <Plug>bujo#CheckTodoInsert
